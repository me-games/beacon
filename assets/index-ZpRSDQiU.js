...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Us(e,t,n){let r=new Float32Array(ks),i=new B(0,1,0);return new Na({name:`SphericalGaussianBlur`,defines:{n:ks,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ks(),fragmentShader:`
...
`)}var yl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function bl(e,t){let n=yl[t];return n===void 0?(I(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var xl=new B;function Sl(){return H.getLuminanceCoefficients(xl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${xl.x.toFixed(4)}, ${xl.y.toFixed(4)}, ${xl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=dl(i,i.VERTEX_SHADER,y),S=dl(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=_l(i,x,`vertex`),n=_l(i,S,`fragment`);L(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
The format should be roomId:reconnectionToken`);return yield this.createMatchMakeRequest(`reconnect`,t,{reconnectionToken:r},n)})}consumeSeatReservation(e,r,i){return t.__awaiter(this,void 0,void 0,function*(){let a=this.createRoom(e.room.name,r);a.roomId=e.room.roomId,a.sessionId=e.sessionId;let o={sessionId:a.sessionId};e.reconnectionToken&&(o.reconnectionToken=e.reconnectionToken);let s=i||a;return a.connect(this.buildEndpoint(e.room,o,e.protocol),e.devMode&&(()=>t.__awaiter(this,void 0,void 0,function*(){console.info(`[Colyseus devMode]: ${String.fromCodePoint(128260)} Re-establishing connection with room id '${a.roomId}'...`);let n=0,i=()=>t.__awaiter(this,void 0,void 0,function*(){n++;try{yield this.consumeSeatReservation(e,r,s),console.info(`[Colyseus devMode]: ${String.fromCodePoint(9989)} Successfully re-established connection with room '${a.roomId}'`)}catch{n<8?(console.info(`[Colyseus devMode]: ${String.fromCodePoint(128260)} retrying... (${n} out of 8)`),setTimeout(i,2e3)):console.info(`[Colyseus devMode]: ${String.fromCodePoint(10060)} Failed to reconnect. Is your server running? Please check server logs.`)}});setTimeout(i,2e3)})),s,e,this.http.headers),new Promise((e,t)=>{let r=(e,r)=>t(new n.ServerError(e,r));s.onError.once(r),s.onJoin.once(()=>{s.onError.remove(r),e(s)})})})}createMatchMakeRequest(e,n){return t.__awaiter(this,arguments,void 0,function*(e,t,n={},r,i){let a=(yield this.http.post(`matchmake/${e}/${t}`,{headers:{Accept:`application/json`,"Content-Type":`application/json`},body:JSON.stringify(n)})).data;if(a.error)throw new s(a.error,a.code);return e===`reconnect`&&(a.reconnectionToken=n.reconnectionToken),yield this.consumeSeatReservation(a,r,i)})}createRoom(e,t){return new r.Room(e,t)}buildEndpoint(e,t={},n=`ws`){let r=this.settings.searchParams||``;this.http.authToken&&(t._authToken=this.http.authToken);for(let e in t)t.hasOwnProperty(e)&&(r+=(r?`&`:``)+`${e}=${t[e]}`);n===`h3`&&(n=`http`);let i=this.settings.secure?`${n}s://`:`${n}://`;e.publicAddress?i+=`${e.publicAddress}`:i+=`${this.settings.hostname}${this.getEndpointPort()}${this.settings.pathname}`;let a=`${i}/${e.processId}/${e.roomId}?${r}`;return this.urlBuilder?this.urlBuilder(new URL(a)):a}getHttpEndpoint(e=``){let t=e.startsWith(`/`)?e:`/${e}`,n=`${this.settings.secure?`https`:`http`}://${this.settings.hostname}${this.getEndpointPort()}${this.settings.pathname}${t}`;return this.settings.searchParams&&(n+=`?${this.settings.searchParams}`),this.urlBuilder?this.urlBuilder(new URL(n)):n}getEndpointPort(){return this.settings.port!==80&&this.settings.port!==443?`:${this.settings.port}`:``}};u.VERSION=`0.16.22`,e.Client=u,e.MatchMakeError=s})),Kp=a((e=>{e.NoneSerializer=class{setState(e){}getState(){return null}patch(e){}teardown(){}handshake(e){}}})),qp=a((e=>{Nu();var t=Gp(),n=Td(),r=jp(),i=Up(),a=yd(),o=kd(),s=Kp(),c=Ed();c.registerSerializer(`schema`,o.SchemaSerializer),c.registerSerializer(`none`,s.NoneSerializer),e.Client=t.Client,e.MatchMakeError=t.MatchMakeError,Object.defineProperty(e,"ErrorCode",{enumerable:!0,get:function(){return n.ErrorCode}}),Object.defineProperty(e,"Protocol",{enumerable:!0,get:function(){return n.Protocol}}),e.Room=r.Room,e.Auth=i.Auth,e.ServerError=a.ServerError,e.SchemaSerializer=o.SchemaSerializer,e.getStateCallbacks=o.getStateCallbacks,e.registerSerializer=c.registerSerializer}))(),Jp=`play`;function Yp(e){if(!e)return{};try{let t=JSON.parse(e);return t&&typeof t==`object`?t:{}}catch{return{}}}function Xp(e){if(e!=null)try{return JSON.parse(e)}catch{return}}async function Zp(e){let t=await new qp.Client(e.url).joinOrCreate(Jp,{gameId:e.room,name:e.name,...e.options}),n=new Map,r=new Set,i=new Set([`join`,`leave`,`change`,`shared`]),a=(e,...t)=>n.get(e)?.forEach(e=>e(...t)),o=(0,qp.getStateCallbacks)(t);return o(t.state).players.onAdd((e,t)=>{a(`join`,t,Yp(e.data)),o(e).onChange(()=>a(`change`,t,Yp(e.data)))}),o(t.state).players.onRemove((e,t)=>a(`leave`,t)),o(t.state).shared.onAdd((e,t)=>a(`shared`,t,Xp(e))),{id:t.sessionId,get players(){let e=new Map;return t.state?.players?.forEach((t,n)=>e.set(n,{id:n,name:t.name,state:Yp(t.data)})),e},me:{set(e){t.send(`state`,JSON.stringify(e))}},shared:{get(e){return Xp(t.state?.shared?.get(e))},set(e,n){t.send(`shared`,{key:e,value:JSON.stringify(n)})},keys(){return t.state?.shared?Array.from(t.state.shared.keys()):[]}},on:((e,o)=>{let s=n.get(e);return s||n.set(e,s=new Set),s.add(o),!i.has(e)&&!r.has(e)&&(r.add(e),t.onMessage(e,t=>a(e,t))),()=>{s?.delete(o)}}),send(e,n){t.send(e,n)},leave(){t.leave()}}}var Qp={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},$p=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},em=new Po(-1,1,1,-1,0,1),tm=new class extends Vr{constructor(){super(),this.setAttribute(`position`,new kr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new kr([0,2,0,0,2,0],2))}},nm=class{constructor(e){this._mesh=new pi(tm,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,em)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},rm=class extends $p{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Na?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Aa.clone(e.uniforms),this.material=new Na({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new nm(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},im=class extends $p{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},am=class extends $p{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},om=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new z);this._width=n.width,this._height=n.height,t=new cn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:E}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new rm(Qp),this.copyPass.material.blending=0,this.timer=new qo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}im!==void 0&&(r instanceof im?n=!0:r instanceof am&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new z);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}};function sm(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function cm(e){let t=new Map,n=new Map,r=e.clone();return lm(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function lm(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)lm(e.children[r],t.children[r],n)}var um=class extends co{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new gm(e)}),this.register(function(e){return new _m(e)}),this.register(function(e){return new Em(e)}),this.register(function(e){return new Dm(e)}),this.register(function(e){return new Om(e)}),this.register(function(e){return new ym(e)}),this.register(function(e){return new bm(e)}),this.register(function(e){return new xm(e)}),this.register(function(e){return new Sm(e)}),this.register(function(e){return new hm(e)}),this.register(function(e){return new Cm(e)}),this.register(function(e){return new vm(e)}),this.register(function(e){return new Tm(e)}),this.register(function(e){return new wm(e)}),this.register(function(e){return new pm(e)}),this.register(function(e){return new km(e,Q.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new km(e,Q.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new Am(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=Lo.extractUrlBase(e);a=Lo.resolveURL(t,this.path)}else a=Lo.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new fo(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===jm){try{a[Q.KHR_BINARY_GLTF]=new Pm(e)}catch(e){r&&r(e);return}i=JSON.parse(a[Q.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new oh(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case Q.KHR_MATERIALS_UNLIT:a[t]=new mm;break;case Q.KHR_DRACO_MESH_COMPRESSION:a[t]=new Fm(i,this.dracoLoader);break;case Q.KHR_TEXTURE_TRANSFORM:a[t]=new Im;break;case Q.KHR_MESH_QUANTIZATION:a[t]=new Lm;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function dm(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function fm(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var Q={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},pm=class{constructor(e){this.parser=e,this.name=Q.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new W(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],Qe);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new Io(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new No(s),o.distance=c;break;case`spot`:o=new jo(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),Qm(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},mm=class{constructor(){this.name=Q.KHR_MATERIALS_UNLIT}getMaterialType(){return ti}extendParams(e,t,n){let r=[];e.color=new W(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],Qe),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,Ze))}return Promise.all(r)}},hm=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},gm=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return fm(this.parser,e,this.name)===null?null:Ia}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new z(e,e)}return Promise.all(r)}},_m=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_DISPERSION}getMaterialType(e){return fm(this.parser,e,this.name)===null?null:Ia}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},vm=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return fm(this.parser,e,this.name)===null?null:Ia}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},ym=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_SHEEN}getMaterialType(e){return fm(this.parser,e,this.name)===null?null:Ia}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new W(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],Qe)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,Ze)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},bm=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return fm(this.parser,e,this.name)===null?null:Ia}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},xm=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_VOLUME}getMaterialType(e){return fm(this.parser,e,this.name)===null?null:Ia}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new W().setRGB(i[0],i[1],i[2],Qe),Promise.all(r)}},Sm=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_IOR}getMaterialType(e){return fm(this.parser,e,this.name)===null?null:Ia}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);return n===null?Promise.resolve():(t.ior=n.ior===void 0?1.5:n.ior,t.ior===0&&(t.ior=1e3),Promise.resolve())}},Cm=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_SPECULAR}getMaterialType(e){return fm(this.parser,e,this.name)===null?null:Ia}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new W().setRGB(i[0],i[1],i[2],Qe),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,Ze)),Promise.all(r)}},wm=class{constructor(e){this.parser=e,this.name=Q.EXT_MATERIALS_BUMP}getMaterialType(e){return fm(this.parser,e,this.name)===null?null:Ia}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},Tm=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return fm(this.parser,e,this.name)===null?null:Ia}extendMaterialParams(e,t){let n=fm(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},Em=class{constructor(e){this.parser=e,this.name=Q.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},Dm=class{constructor(e){this.parser=e,this.name=Q.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Om=class{constructor(e){this.parser=e,this.name=Q.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},km=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}else return null}},Am=class{constructor(e){this.name=Q.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==Vm.TRIANGLES&&e.mode!==Vm.TRIANGLE_STRIP&&e.mode!==Vm.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new U,n=new B,a=new Ht,s=new B(1,1,1),c=new zi(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new ji(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);Ln.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},jm=`glTF`,Mm=12,Nm={JSON:1313821514,BIN:5130562},Pm=class{constructor(e){this.name=Q.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,Mm),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==jm)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-Mm,i=new DataView(e,Mm),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===Nm.JSON){let r=new Uint8Array(e,Mm+a,t);this.content=n.decode(r)}else if(r===Nm.BIN){let n=Mm+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},Fm=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=Q.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=Km[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=Km[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=Hm[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,Qe,n)})})}},Im=class{constructor(){this.name=Q.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},Lm=class{constructor(){this.name=Q.KHR_MESH_QUANTIZATION}},Rm=class extends Ua{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},zm=new Ht,Bm=class extends Rm{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return zm.fromArray(i).normalize().toArray(i),i}},Vm={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},Hm={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Um={9728:p,9729:g,9984:m,9985:_,9986:h,9987:v},Wm={33071:d,33648:f,10497:u},Gm={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Km={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},qm={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},Jm={CUBICSPLINE:void 0,LINEAR:Ue,STEP:He},Ym={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function Xm(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new Fa({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function Zm(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function Qm(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function $m(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function eh(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function th(e){let t,n=e.extensions&&e.extensions[Q.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+nh(n.attributes):e.indices+`:`+nh(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+nh(e.targets[n]);return t}function nh(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function rh(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function ih(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var ah=new U,oh=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new dm,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>`u`||n&&r<17||i&&a<98?this.textureLoader=new ho(this.options.manager):this.textureLoader=new zo(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new fo(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return Zm(i,a,r),Qm(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Q.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(Lo.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=Gm[r.type],t=Hm[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new Er(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=Gm[r.type],o=Hm[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new Hr(f,u/s),t.cache.add(n,c)),p=new Wr(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new Er(f,a,d);if(r.sparse!==void 0){let t=Gm.SCALAR,n=Hm[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new Er(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=Um[n.magFilter]||1006,t.minFilter=Um[n.minFilter]||1008,t.wrapS=Wm[n.wrapS]||1e3,t.wrapT=Wm[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new an(e);t.needsUpdate=!0,n(t)}),t.load(Lo.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),Qm(e,a),e.userData.mimeType=a.mimeType||ih(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[Q.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[Q.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[Q.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new ca,Kr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Ji,Kr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return Fa}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[Q.KHR_MATERIALS_UNLIT]){let e=r[Q.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new W(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],Qe),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,Ze)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||Ym.OPAQUE;if(l===Ym.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===Ym.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==ti&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new z(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==ti&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==ti){let e=i.emissiveFactor;o.emissive=new W().setRGB(e[0],e[1],e[2],Qe)}return i.emissiveTexture!==void 0&&a!==ti&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,Ze)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),Qm(n,i),t.associations.set(n,{materials:e}),i.extensions&&Zm(r,n,i),n})}createUniqueName(e){let t=ps.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[Q.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return ch(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=th(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[Q.KHR_DRACO_MESH_COMPRESSION]?i(o):ch(new Vr,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?Xm(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===Vm.TRIANGLES||u.mode===Vm.TRIANGLE_STRIP||u.mode===Vm.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new Ti(l,f):new pi(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===Vm.TRIANGLE_STRIP?d.geometry=sm(d.geometry,1):u.mode===Vm.TRIANGLE_FAN&&(d.geometry=sm(d.geometry,2));else if(u.mode===Vm.LINES)d=new oa(l,f);else if(u.mode===Vm.LINE_STRIP)d=new na(l,f);else if(u.mode===Vm.LINE_LOOP)d=new sa(l,f);else if(u.mode===Vm.POINTS)d=new pa(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&eh(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),Qm(d,i),u.extensions&&Zm(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&Zm(r,c[0],i),c[0];let l=new Rn;i.extensions&&Zm(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new ko(Vt.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new Po(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Qm(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new U;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new Ai(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new no(i,void 0,l);return Qm(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,ah)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new B().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new Ei:t.length>1?new Rn:t.length===1?t[0]:new Ln,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),Qm(o,i),i.extensions&&Zm(n,o,i),i.matrix!==void 0){let e=new U;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new Rn;n.name&&(i.name=r.createUniqueName(n.name)),Qm(i,n),n.extensions&&Zm(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(cm(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Kr||e instanceof an)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];function c(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}qm[i.path]===qm.weights?(c(e),e.isGroup&&e.children.forEach(c)):s.push(o);let l;switch(qm[i.path]){case qm.weights:l=Za;break;case qm.rotation:l=$a;break;case qm.translation:case qm.scale:l=to;break;default:switch(n.itemSize){case 1:l=Za;break;default:l=to;break}break}let u=r.interpolation===void 0?Ue:Jm[r.interpolation],d=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new l(s[e]+`.`+qm[i.path],t.array,d,u);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=rh(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof $a?Bm:Rm)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function sh(e,t,n){let r=t.attributes,i=new cr;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new B(t[0],t[1],t[2]),new B(a[0],a[1],a[2])),e.normalized){let t=rh(Hm[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new B,t=new B;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=rh(Hm[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new Nr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function ch(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=Km[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return H.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${H.workingColorSpace}" not supported.`),Qm(e,t),sh(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:$m(e,t.targets,n)})}var lh=class extends $p{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new W}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},uh={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new W(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},dh=class e extends $p{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new z(256,256):new z(e.x,e.y),this.clearColor=new W(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new cn(i,a,{type:E}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new cn(i,a,{type:E});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new cn(i,a,{type:E});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=uh;this.highPassUniforms=Aa.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new Na({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new z(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new B(1,1,1),new B(1,1,1),new B(1,1,1),new B(1,1,1),new B(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=Aa.clone(Qp.uniforms),this.blendMaterial=new Na({uniforms:this.copyUniforms,vertexShader:Qp.vertexShader,fragmentShader:Qp.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new W,this._oldClearAlpha=1,this._basic=new ti,this._fsQuad=new nm(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new z(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new Na({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new z(.5,.5)},direction:{value:new z(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};dh.BlurDirectionX=new z(1,0),dh.BlurDirectionY=new z(0,1);var fh=``+new URL(`compact-storm-glider-aircraft-with-brass-beacon-la-DYdTbp3I.glb`,import.meta.url).href,ph=``+new URL(`magical-beacon-ignites-with-warm-chime-and-distant-D4Ba4Es5.mp3`,import.meta.url).href,mh=``+new URL(`short-airy-storm-glider-boost-whoosh-lKpHr_K-.mp3`,import.meta.url).href,hh=``+new URL(`stormy-floating-island-sky-with-dark-thunderclouds-B8C4FdTh.jpg`,import.meta.url).href,gh=``+new URL(`basecolor-B17KFq1u.png`,import.meta.url).href,_h={slug:`beacon`,colyseusUrl:`wss://demo-colyseus.glotech.world`,apiUrl:`https://demo-api.glotech.world`},vh=95,yh=1e3,bh=90,xh=18;function Sh(e,t,n){return e+(t-e)*n}function Ch(e,t,n){let r=(t-e)%(Math.PI*2);return r>Math.PI&&(r-=Math.PI*2),r<-Math.PI&&(r+=Math.PI*2),e+r*n}function wh(e,t){let n=(t-e)%(Math.PI*2);return n>Math.PI&&(n-=Math.PI*2),n<-Math.PI&&(n+=Math.PI*2),n}function Th(e,t){let n=t.x-e.x,r=t.y-e.y,i=t.z-e.z;return Math.hypot(n,r,i)}var Eh=class{buffers=new Map;push(e,t,n=performance.now()){let r=this.buffers.get(e);r||(r=[],this.buffers.set(e,r));let i=r[r.length-1];if(i&&i.v.x===t.x&&i.v.y===t.y&&i.v.z===t.z&&i.v.yaw===t.yaw)return;r.push({t:n,v:t});let a=n-yh;for(;r.length>2&&r[0].t<a;)r.shift()}sample(e,t=performance.now()){let n=this.buffers.get(e);if(!n||n.length===0)return null;let r=t-vh;if(n.length===1||r<=n[0].t)return n[0].v;if(r>=n[n.length-1].t){let e=n[n.length-1],t=n[n.length-2];if(!t||Th(t.v,e.v)>xh)return e.v;let i=Math.max(16,e.t-t.t),a=Math.min(r-e.t,bh)/i;return{x:e.v.x+(e.v.x-t.v.x)*a,y:e.v.y+(e.v.y-t.v.y)*a,z:e.v.z+(e.v.z-t.v.z)*a,yaw:e.v.yaw+wh(t.v.yaw,e.v.yaw)*a}}for(let e=0;e<n.length-1;e+=1){let t=n[e],i=n[e+1];if(r>=t.t&&r<=i.t){let e=(r-t.t)/(i.t-t.t||1);return{x:Sh(t.v.x,i.v.x,e),y:Sh(t.v.y,i.v.y,e),z:Sh(t.v.z,i.v.z,e),yaw:Ch(t.v.yaw,i.v.yaw,e)}}}return n[n.length-1].v}remove(e){this.buffers.delete(e)}},Dh=-Math.PI/2;function Oh(e){let t=document.querySelector(e);if(!t)throw Error(`Missing ${e}`);return t}var kh=Oh(`#app`);kh.innerHTML=`
  <canvas id="game"></canvas>
  <div id="hud">
    <div class="hud-title">Storm Beacon</div>
    <div id="beacon-count">Beacons 0 / 5</div>
    <div id="team-count">Team: solo</div>
    <div id="status">Wake every dark beacon before the storm closes in.</div>
  </div>
  <div id="finish" hidden>
    <div>All beacons lit</div>
    <span>The storm is held back.</span>
  </div>
`;var Ah=Oh(`#game`),jh=Oh(`#beacon-count`),Mh=Oh(`#team-count`),Nh=Oh(`#status`),Ph=Oh(`#finish`),Fh=new Mu({canvas:Ah,antialias:!0,powerPreference:`high-performance`});Fh.setPixelRatio(Math.min(window.devicePixelRatio,2)),Fh.setSize(window.innerWidth,window.innerHeight),Fh.outputColorSpace=Ze,Fh.toneMapping=4,Fh.toneMappingExposure=1.08,Fh.shadowMap.enabled=!0,Fh.shadowMap.type=1;var Ih=new qn;Ih.background=new W(463135),Ih.fog=new Kn(660256,.018);var Lh=new ko(58,window.innerWidth/window.innerHeight,.1,650);Lh.position.set(0,15,38);var Rh=new om(Fh);Rh.addPass(new lh(Ih,Lh));var zh=new dh(new z(window.innerWidth,window.innerHeight),.85,.55,.72);Rh.addPass(zh);var Bh=new Io(10403583,2.4);Bh.position.set(-28,44,18),Bh.castShadow=!0,Bh.shadow.camera.near=1,Bh.shadow.camera.far=110,Bh.shadow.camera.left=-60,Bh.shadow.camera.right=60,Bh.shadow.camera.top=60,Bh.shadow.camera.bottom=-60,Ih.add(Bh),Ih.add(new _o(5995962,1053197,1.8));var Vh=new qo;Vh.connect(document);var Hh=new Set,Uh=new Eh,Wh=new Map,Gh=new Map,Kh=new Map,qh=new Set,Jh=new es;Lh.add(Jh);var Yh=null,Xh=null,Zh=null,Qh=null,$h=0,eg=0,tg=0,ng=fg(),$={x:ng.x,y:4.2,z:ng.z,yaw:ng.yaw,boost:!1,lit:0,pulse:0},rg=new B(Math.sin($.yaw),0,Math.cos($.yaw)).multiplyScalar(2.5),ig=vg(6481663,!0);ig.position.set($.x,$.y,$.z),Ih.add(ig);var ag=gg();Ih.add(ag);var og=_g();for(let e of og)Ih.add(e.group);var sg=bg();for(let e of sg)Ih.add(e.group);var cg=xg();Ih.add(cg.points);var lg=Sg();Ih.add(lg),dg(),pg(),mg(),window.addEventListener(`keydown`,e=>{Hh.add(e.code),Rg()}),window.addEventListener(`keyup`,e=>{Hh.delete(e.code)}),window.addEventListener(`pointerdown`,()=>{Rg()}),window.addEventListener(`resize`,Bg);var ug=window.setInterval(()=>{Yh&&(tg+=1,$.pulse=tg,Yh.me.set({...$}))},50);window.addEventListener(`beforeunload`,()=>{window.clearInterval(ug),Yh?.leave()}),window.addEventListener(`pagehide`,()=>{Yh?.leave()}),Cg();async function dg(){let e=new ho;try{let t=await e.loadAsync(hh);t.mapping=303,t.colorSpace=Ze,Ih.background=t;let n=new Rs(Fh);Ih.environment=n.fromEquirectangular(t).texture,n.dispose()}catch{Ih.environment=null}try{let t=await e.loadAsync(gh);t.colorSpace=Ze,t.wrapS=u,t.wrapT=u,t.repeat.set(9,9),t.anisotropy=Fh.capabilities.getMaxAnisotropy();let n=ag.children.find(e=>e.name===`island-top`);n&&(n.material.map=t,n.material.needsUpdate=!0)}catch{Nh.textContent=`Storm ground is using a temporary surface.`}try{Qh=(await new um().loadAsync(fh)).scene,Qh.name=`storm-glider-template`,Qh.scale.setScalar(1.6),Qh.rotation.y=Dh,Qh.traverse(e=>{e instanceof pi&&(e.castShadow=!0,e.receiveShadow=!0)}),yg(ig);for(let e of Wh.values())yg(e)}catch{Nh.textContent=`Player craft is using a temporary shape until the model arrives.`}}function fg(){let e=Math.random()*Math.PI*2,t=6+Math.random()*6;return{x:Math.sin(e)*t,z:Math.cos(e)*t,yaw:e+Math.PI}}async function pg(){let e=new Ho;try{Xh=await e.loadAsync(ph)}catch{Xh=null}try{Zh=await e.loadAsync(mh)}catch{Zh=null}}async function mg(){try{Yh=await Zp({url:_h.colyseusUrl,room:_h.slug,name:`pilot-${Math.floor(Math.random()*900+100)}`}),Yh.me.set({...$}),hg(Yh.shared.get(`beacons`)),Yh.on(`join`,(e,t)=>{if(e!==Yh?.id){if(!jg(t)){Mg(e),qh.add(e);return}qh.delete(e),Ig(e),Ag(e,t)}}),Yh.on(`change`,(e,t)=>{if(e!==Yh?.id){if(!jg(t)){Mg(e),qh.add(e);return}qh.delete(e),Ig(e),Ag(e,t)}}),Yh.on(`leave`,e=>{let t=Wh.get(e);t&&(Ih.remove(t),Wh.delete(e));let n=Gh.get(e);n&&(n.remove(),Gh.delete(e)),Kh.delete(e),qh.delete(e),Uh.remove(e)}),Yh.on(`shared`,(e,t)=>{e===`beacons`&&hg(t)});let e=Yh.shared.get(`beacons`);Array.isArray(e)||Yh.shared.set(`beacons`,og.map(e=>e.lit))}catch{Mh.textContent=`Team: solo`,Nh.textContent=`Solo flight is ready; team flight will join when the room connects.`}}function hg(e){Array.isArray(e)&&e.forEach((e,t)=>{let n=og[t];n&&e===!0&&(n.lit=!0,n.progress=1)})}function gg(){let e=new Rn,t=new ba(38,27,7,96,3),n=t.attributes.position,r=new B;for(let e=0;e<n.count;e+=1){r.fromBufferAttribute(n,e);let t=Math.atan2(r.z,r.x),i=1+.08*Math.sin(t*5)+.05*Math.cos(t*9);r.x*=i,r.z*=i,r.y<-2&&(r.y-=(Math.abs(Math.sin(t*3))+.4)*2.4),n.setXYZ(e,r.x,r.y-2.8,r.z)}t.computeVertexNormals();let i=new pi(t,new Fa({color:5005130,roughness:.95,metalness:0}));i.name=`island-top`,i.castShadow=!0,i.receiveShadow=!0,e.add(i);let a=new pi(new xa(28,28,96),new Fa({color:2105378,roughness:.9,metalness:0}));a.position.y=-20,a.castShadow=!0,a.receiveShadow=!0,e.add(a);let o=new Fa({color:3097401,emissive:463889,roughness:.8});for(let t=0;t<18;t+=1){let n=t/18*Math.PI*2,r=new pi(new ba(.28,.55,10+t%3*2,8),o);r.position.set(Math.cos(n)*32,-8,Math.sin(n)*32),r.rotation.z=Math.cos(n)*.45,r.rotation.x=Math.sin(n)*-.45,r.castShadow=!0,e.add(r)}return e}function _g(){let e=[];for(let t=0;t<5;t+=1){let n=t/5*Math.PI*2+.35,r=new B(Math.cos(n)*24,2,Math.sin(n)*24),i=new Rn;i.position.copy(r);let a=new pi(new ba(1.25,1.8,3.2,18),new Fa({color:2107702,roughness:.7,metalness:.15}));a.position.y=.8,a.castShadow=!0,a.receiveShadow=!0,i.add(a);let o=new pi(new ba(.35,.65,5.8,14),new Fa({color:3754072,roughness:.52,metalness:.35}));o.position.y=4.3,o.castShadow=!0,i.add(o);let s=new pi(new Ca(1.1,32,16),new Fa({color:857893,emissive:398374,emissiveIntensity:.35,roughness:.35}));s.position.y=7.7,i.add(s);let c=new pi(new wa(2.2,.055,10,80),new ti({color:5698303,transparent:!0,opacity:.1}));c.position.y=7.7,c.rotation.x=Math.PI/2,i.add(c);let l=new pi(new ba(.6,1.6,28,32,1,!0),new ti({color:7403519,transparent:!0,opacity:0,depthWrite:!1,blending:2}));l.position.y=20,i.add(l);let u=new No(5630719,0,32);u.position.y=8,i.add(u),e.push({group:i,core:s,beam:l,halo:c,light:u,position:r,progress:0,lit:!1})}return e}function vg(e,t){let n=new Rn;n.scale.setScalar(t?1.38:1.2);let r=new Rn;r.name=`fallback-ship`;let i=new pi(new xa(.78,2.4,4),new Fa({color:e,emissive:e,emissiveIntensity:t?.35:.18,roughness:.42,metalness:.25}));i.rotation.x=Math.PI/2,i.castShadow=!0,r.add(i);let a=new Fa({color:1582899,emissive:e,emissiveIntensity:t?.14:.08,roughness:.48,metalness:.18}),o=new pi(new ya(2.4,.1,.7),a);o.position.set(-1.1,-.12,.15),o.rotation.z=-.18,o.castShadow=!0,r.add(o);let s=o.clone();s.position.x=1.1,s.rotation.z=.18,r.add(s);let c=new pi(new Ca(.32,16,8),new ti({color:16242809}));c.position.z=1.25,r.add(c);let l=new pi(new xa(.22,1.8,18,1,!0),new ti({color:e,transparent:!0,opacity:.34,depthWrite:!1,blending:2}));return l.name=`boost-trail`,l.position.z=-1.4,l.rotation.x=Math.PI/2,n.add(l),n.add(r),n}function yg(e){if(!Qh||e.getObjectByName(`storm-glider-model`))return;let t=Qh.clone(!0);t.name=`storm-glider-model`,e.add(t);let n=e.getObjectByName(`fallback-ship`);n&&(n.visible=!1)}function bg(){let e=[],t=new Fa({color:1511724,emissive:5120936,emissiveIntensity:.7,roughness:.55,transparent:!0,opacity:.82});for(let n=0;n<6;n+=1){let r=n/6*Math.PI*2,i=new Rn,a=new pi(new Ca(.95,18,10),t),o=new pi(new xa(.42,2.2,16,1,!0),new ti({color:6829784,transparent:!0,opacity:.22,depthWrite:!1,blending:2}));o.position.z=1.4,o.rotation.x=Math.PI/2,i.add(a,o);let s=new B(Math.cos(r)*29,5.8,Math.sin(r)*29);i.position.copy(s),e.push({group:i,home:s,seed:n*7.13})}return e}function xg(){let e=new Float32Array(950*3);for(let t=0;t<950;t+=1)e[t*3]=(Math.random()-.5)*130,e[t*3+1]=Math.random()*70+5,e[t*3+2]=(Math.random()-.5)*130;let t=new Vr;return t.setAttribute(`position`,new Er(e,3)),{points:new pa(t,new ca({color:10010623,size:.06,transparent:!0,opacity:.42,depthWrite:!1})),positions:e}}function Sg(){let e=[new B(-34,58,-45),new B(-29,46,-39),new B(-34,34,-36),new B(-26,23,-32)];return new na(new Vr().setFromPoints(e),new Ji({color:9362687,transparent:!0,opacity:0,blending:2}))}function Cg(e){requestAnimationFrame(Cg),Vh.update(e);let t=Math.min(Vh.getDelta(),.04);eg+=t,$h=Math.max(0,$h-t),wg(t),Tg(t),Eg(t),Dg(t),Og(),kg(),Pg(t),Fg(),Rh.render()}function wg(e){let t=Number(Hh.has(`KeyA`)||Hh.has(`ArrowLeft`))-Number(Hh.has(`KeyD`)||Hh.has(`ArrowRight`));$.yaw+=t*e*2.6;let n=Hh.has(`KeyW`)||Hh.has(`ArrowUp`),r=Hh.has(`KeyS`)||Hh.has(`ArrowDown`);$.boost=Hh.has(`Space`)&&n;let i=new B(Math.sin($.yaw),0,Math.cos($.yaw));n&&rg.addScaledVector(i,e*($.boost?24:13)),r&&rg.multiplyScalar(.12**e),rg.multiplyScalar(.78**e);let a=$.boost?22:14;rg.length()>a&&rg.setLength(a),$.x+=rg.x*e,$.z+=rg.z*e;let o=Math.hypot($.x,$.z);if(o>40){let t=new B(-$.x,0,-$.z).normalize();rg.addScaledVector(t,e*(o-37)*3)}$.y=4.2+Math.sin(eg*2.7)*.24+Math.min(1.2,rg.length()*.035),ig.position.set($.x,$.y,$.z),ig.rotation.y=$.yaw,ig.rotation.z=Vt.lerp(ig.rotation.z,-t*.32,1-Math.exp(-e*7));let s=ig.getObjectByName(`boost-trail`);s&&(s.visible=$.boost,s.scale.setScalar(1+Math.sin(eg*30)*.16)),$.boost&&$h===0&&(zg(Zh,.23),$h=.7)}function Tg(e){let t=new B($.x,$.y,$.z),n=!1;for(let r of og){!r.lit&&t.distanceTo(r.position)<7.2?(r.progress+=e*.52,Nh.textContent=`Hold close. The beacon is waking up.`,r.progress>=1&&(r.lit=!0,r.progress=1,n=!0,zg(Xh,.55))):r.lit||(r.progress=Math.max(0,r.progress-e*.22));let i=r.lit?1:r.progress;r.core.material.color.setHSL(.52,.82,.08+i*.48),r.core.material.emissive.setHSL(.52,.88,.08+i*.42),r.core.material.emissiveIntensity=.45+i*2.8,r.light.intensity=i*13,r.beam.material.opacity=r.lit?.22+Math.sin(eg*4)*.04:i*.08,r.halo.material.opacity=.08+i*.72,r.halo.scale.setScalar(.78+i*.52+Math.sin(eg*3+r.position.x)*.025),r.halo.rotation.z+=e*(.5+i*1.8)}n&&($.lit=og.filter(e=>e.lit).length,Yh?.shared.set(`beacons`,og.map(e=>e.lit)))}function Eg(e){let t=new B($.x,$.y,$.z);for(let n of sg){let r=new B(Math.sin(eg*.7+n.seed)*3.5,Math.sin(eg*1.9+n.seed)*1.2,Math.cos(eg*.6+n.seed)*3.5),i=n.home.clone().add(r);if(n.group.position.lerp(i,1-Math.exp(-e*1.8)),n.group.lookAt(ig.position),n.group.position.distanceTo(t)<3.2){let r=t.clone().sub(n.group.position).setY(0).normalize();rg.addScaledVector(r,e*25),Nh.textContent=`A storm shade shoved you off the beacon path.`}}}function Dg(e){let t=cg.positions;for(let n=0;n<t.length/3;n+=1){let r=n*3;t[r]-=e*8,t[r+1]-=e*46,t[r+2]+=e*3,t[r+1]<-8&&(t[r]=$.x+(Math.random()-.5)*120,t[r+1]=64+Math.random()*18,t[r+2]=$.z+(Math.random()-.5)*120)}let n=cg.points.geometry.getAttribute(`position`);n.needsUpdate=!0}function Og(){let e=lg.material;Array.isArray(e)||(e.opacity=Math.sin(eg*.75)>.985||Math.sin(eg*1.7)>.995?.9:Math.max(0,e.opacity-.08))}function kg(){if(!Yh)return;let e=1,t=new Set,n=performance.now();for(let[r,i]of Yh.players){if(r===Yh.id||qh.has(r))continue;if(!jg(i.state)){Mg(r),qh.add(r);continue}Wh.get(r)||(Ig(r),Ag(r,i.state));let a=Kh.get(r)??0;if(a>0&&n-a>4500){Mg(r),qh.add(r);continue}t.add(r),e+=1;let o=i.state,s=Ig(r),c=Uh.sample(r);if(!c)continue;s.position.set(c.x,c.y,c.z),s.rotation.y=c.yaw;let l=s.getObjectByName(`boost-trail`);l&&(l.visible=!!o.boost),Ng(r,c,i.name)}for(let e of Wh.keys())t.has(e)||Mg(e);Mh.textContent=e>1?`Team: ${e} pilots`:`Team: waiting for friend`}function Ag(e,t){Kh.set(e,performance.now()),Uh.push(e,{x:Number(t.x)||0,y:Number(t.y)||4,z:Number(t.z)||0,yaw:Number(t.yaw)||0})}function jg(e){let t=Number(e.pulse);return Number.isFinite(t)&&t>0}function Mg(e){let t=Wh.get(e);t&&(Ih.remove(t),Wh.delete(e));let n=Gh.get(e);n&&(n.remove(),Gh.delete(e)),Kh.delete(e),Uh.remove(e)}function Ng(e,t,n){let r=Gh.get(e);r||(r=document.createElement(`div`),r.className=`pilot-label`,kh.appendChild(r),Gh.set(e,r));let i=new B(t.x,t.y+2.5,t.z).project(Lh),a=i.z<1;r.hidden=!a,a&&(r.textContent=n||`pilot`,r.style.transform=`translate(${(i.x*.5+.5)*window.innerWidth}px, ${(-i.y*.5+.5)*window.innerHeight}px)`)}function Pg(e){let t=$.yaw,n=new B(-Math.sin(t),0,-Math.cos(t)),r=new B($.x,$.y+1.25,$.z).addScaledVector(rg,.06),i=r.clone().addScaledVector(n,9.8).add(new B(0,5.4,0));Lh.position.lerp(i,1-Math.exp(-e*4.5)),Lh.lookAt(r)}function Fg(){let e=og.filter(e=>e.lit).length;$.lit=e,jh.textContent=`Beacons ${e} / ${og.length}`,e===og.length?(Ph.hidden=!1,Nh.textContent=`The storm is held back. Fly laps through the lit beams.`):!Nh.textContent.includes(`Hold close`)&&!Nh.textContent.includes(`shoved`)&&(Nh.textContent=`Wake every dark beacon before the storm closes in.`)}function Ig(e){let t=Wh.get(e);if(!t){let n=Lg(e)%360/360;t=vg(new W().setHSL(n,.88,.62).getHex(),!1),yg(t),Ih.add(t),Wh.set(e,t)}return t}function Lg(e){let t=0;for(let n=0;n<e.length;n+=1)t=t*31+e.charCodeAt(n)>>>0;return t}async function Rg(){Jh.context.state===`suspended`&&await Jh.context.resume()}function zg(e,t){if(!e||Jh.context.state!==`running`)return;let n=new ts(Jh);n.setBuffer(e),n.setVolume(t),n.play()}function Bg(){let e=window.innerWidth,t=window.innerHeight;Lh.aspect=e/t,Lh.updateProjectionMatrix(),Fh.setSize(e,t),Rh.setSize(e,t),zh.setSize(e,t)}